        ...
        <section className="rounded-lg border border-white/15 bg-card/[0.96] p-2 text-[#0f172c] shadow-2xl shadow-black/30 backdrop-blur sm:p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <LockIcon className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-[#6b7280]" />
                <Input
                  autoComplete="current-password"
                  className="h-12 border-accent bg-[#0f172c] pl-10 pr-11 text-[#0f172c] placeholder:text-[#8b95a5] focus-visible:ring-[#00a2e0]/20"
                  id="password"
